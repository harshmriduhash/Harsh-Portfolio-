...
const configs = {
  ...
  navTitle: 'Harsh Mriduhash portfolio.',
  relevantStops: STOPS,
  pages: [
    {
      scale: 15,
      ...
      title: 'Who Am I?',
      infos: [
        "* I'm a maker, a curious thinker and storytelling who enjoys learning and comprehending how things function.",
        '* My journey as a software developer started when I was a just a kid trying to figure out how video games where made.',
        '* I started my career as a front-end developer 5 years ago in 2018, and since then I have helped many startup companies and organizations to develop quality products.',
        ...
        items: [
          {
            ...
            websiteURL:
              'https://www.linkedin.com/in/harsh-s-2ab5a0158/',
          },
          {
            url: 'icons/github.png',
            websiteURL: 'https://github.com/harshmriduhash?tab=repositories',
          },
          {
            url: 'icons/email.png',
            websiteURL: 'mailto:Harshsahay2709@gmail.com',
          },
        ],
      },
    },
